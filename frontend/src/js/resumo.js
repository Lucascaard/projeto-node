document.addEventListener("DOMContentLoaded", () => {
  ...
  .then(data => {
    data.forEach(cliente => {
      ...
      //A instancia venda é um `array` de `arrays` então é necessário dois loops, um para entrar no primeiro array e outro para percorrer os arrays que estão ali dentro
